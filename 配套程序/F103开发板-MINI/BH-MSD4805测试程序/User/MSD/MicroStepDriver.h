...
// 步进电机方向控制
#define            MSD_DIR_GPIO_CLK                 RCC_APB2Periph_GPIOA
#define            MSD_DIR_PORT                     GPIOA
#define            MSD_DIR_PIN                      GPIO_Pin_4

// 步进电机输出使能引脚
#define            MSD_ENA_GPIO_CLK                 RCC_APB2Periph_GPIOA
#define            MSD_ENA_PORT                     GPIOA
#define            MSD_ENA_PIN                      GPIO_Pin_5
